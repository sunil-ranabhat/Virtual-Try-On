...
def main():
    ...
    # Read input image
    img=cv2.imread("C:/Users/Sishir512/Desktop/Major project/virtual/myapp/static/origin_web.jpg")
    ...
    os.chdir("C:/Users/Sishir512/Desktop/Major project/virtual/myapp/Graphonomy-master")
    ...
    terminnal_command = "python test_generator.py --cuda True --test_name test1 --tocg_checkpoint mtviton.pth --gpu_ids 0 --gen_checkpoint gen.pth --datasetting unpaired --data_list t2.txt --dataroot ./test" 
    os.system(terminnal_command)
